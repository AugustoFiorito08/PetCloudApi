...
{
    /// <inheritdoc />
    public partial class EstructuraOficialPDF : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Veterinario = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RegistrosSanitarios_Mascotas_MascotaId",
                        column: x => x.MascotaId,
                        principalTable: "Mascotas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RegistrosSanitarios_Vacunas_VacunaId",
                        column: x => x.VacunaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistrosSanitarios_MascotaId",
                table: "RegistrosSanitarios",
                column: "MascotaId");

            migrationBuilder.CreateIndex(
                name: "IX_RegistrosSanitarios_VacunaId",
                table: "RegistrosSanitarios",
                column: "VacunaId");
        }
